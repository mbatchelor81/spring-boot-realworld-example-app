...
public class DefaultJwtServiceTest {
  ...
  private static final String TEST_SECRET =
      "1231231231231231231231231231231231231231231231231231231231231231231231231231";
  ...
  public void should_get_null_with_expired_jwt() {
    SecretKey key = new SecretKeySpec(TEST_SECRET.getBytes(), "HmacSHA512");
    String token =
        Jwts.builder()
            .subject("aisensiy")
            .expiration(new Date(1502161204000L))
