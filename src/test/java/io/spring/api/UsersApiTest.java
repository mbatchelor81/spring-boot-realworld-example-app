...
public class UsersApiTest {
  ...
  @Test
  public void should_show_error_message_for_null_password() throws Exception {
    String email = "john@jacob.com";
    String username = "johnjacob";
  ...
  @Test
  public void should_show_error_message_for_null_email() throws Exception {
    String username = "johnjacob";
  ...
  @Test
  public void should_show_error_message_for_null_username() throws Exception {
    String email = "john@jacob.com";
  ...
  @Test
  public void should_show_error_for_empty_registration_body() throws Exception {
    given()
        .contentType("application/json")
        .body(
            new HashMap<String, Object>() {
  ...
  @Test
  public void should_show_error_for_blank_email_during_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_blank_password_during_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_invalid_email_format_during_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_null_email_during_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_null_password_during_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
