...
public class UsersApiTest {
  ...
  @Test
  public void should_show_error_for_missing_user_object_on_register() throws Exception {
  ...
  @Test
  public void should_show_error_for_null_email_on_register() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_both_email_and_username_duplicated() throws Exception {
    String email = "john@jacob.com";
    String username = "johnjacob";

    when(userRepository.findByEmail(eq(email)))
        .thenReturn(Optional.of(new User(email, "otheruser", "123", "bio", "")));
    when(userRepository.findByUsername(eq(username)))
  ...
  @Test
  public void should_fail_login_with_missing_user_object() throws Exception {
    Map<String, Object> param = new HashMap<>();
  ...
  @Test
  public void should_fail_login_with_null_email() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_fail_login_with_null_password() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
