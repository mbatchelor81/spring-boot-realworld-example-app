...
public class UsersApiTest {
  ...
  public void should_show_error_for_duplicated_email_and_username() throws Exception {
    ...
    when(userRepository.findByUsername(eq(username)))
        .thenReturn(Optional.of(new User("other@email.com", username, "123", "bio", "")));
  ...
  public void should_fail_login_with_wrong_password() throws Exception {
    ...
    Map<String, Object> param = prepareLoginParameter(email, "123123");
  ...
  public void should_fail_login_with_nonexistent_email() throws Exception {
    ...
    Map<String, Object> param = prepareLoginParameter(email, "password123");
  ...
  public void should_fail_login_with_blank_email() throws Exception {
    Map<String, Object> param = prepareLoginParameter("", "password123");
  ...
  public void should_fail_login_with_blank_password() throws Exception {
    Map<String, Object> param = prepareLoginParameter("john@jacob.com", "");
  ...
  public void should_fail_login_with_invalid_email_format() throws Exception {
    Map<String, Object> param = prepareLoginParameter("not-an-email", "password123");
  ...
  @Test
  public void should_show_error_for_missing_email_field_in_register() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_missing_username_field_in_register() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_missing_password_field_in_register() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
