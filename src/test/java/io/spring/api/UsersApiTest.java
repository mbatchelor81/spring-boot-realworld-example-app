...
public class UsersApiTest {
  ...
  @Test
  public void should_show_error_for_null_email() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_null_username() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_null_password() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_multiple_errors_for_duplicated_email_and_username() throws Exception {
    String email = "john@jacob.com";
    String username = "johnjacob";
  ...
  @Test
  public void should_show_error_for_null_email_on_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_null_password_on_login() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
