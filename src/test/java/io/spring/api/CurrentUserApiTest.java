...
public class CurrentUserApiTest extends TestWithCurrentUser {
  ...
  public void should_get_error_if_both_email_and_username_exist_when_update() throws Exception {
    ...
    when(userRepository.findByUsername(eq(newUsername)))
        .thenReturn(Optional.of(new User("someone@example.com", newUsername, "123", "", "")));
        ...
        new HashMap<String, Object>() {
          {
            put(
                ...
                new HashMap<String, Object>() {
                  {
                    put("image", "http://new-image.url/pic.jpg");
                  }
                });
          }
        };
  ...
  @Test
  public void should_update_user_profile_with_invalid_email_format() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_update_user_profile_with_password() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_update_user_profile_with_all_fields() throws Exception {
    String newEmail = "updated@example.com";
    String newBio = "updated bio";
    String newUsername = "updateduser";
    String newImage = "http://new-image.url";
  ...
  @Test
  public void should_allow_update_with_own_email() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_allow_update_with_own_username() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_get_current_user_with_correct_response_body() throws Exception {
    String bio = "my bio";
    String image = "http://image.url/pic.jpg";
    UserData detailedUserData = new UserData(user.getId(), email, username, bio, image);
    when(userQueryService.findById(any())).thenReturn(Optional.of(detailedUserData));
