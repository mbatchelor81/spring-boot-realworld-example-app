...
public class CurrentUserApiTest extends TestWithCurrentUser {
  ...
  @Test
  public void should_get_multiple_errors_when_update_user_profile() throws Exception {
    ...
    when(userRepository.findByUsername(eq(newUsername)))
        .thenReturn(Optional.of(new User("other1@example.com", newUsername, "123", "", "")));
    when(userRepository.findByEmail(eq(newEmail)))
        .thenReturn(Optional.of(new User(newEmail, "other2", "123", "", "")));
